...
public class PartesMoModel extends BaseModel {
	...
	public static final String HORARIOS_BUCKET = "horarios";
	...
	private boolean _corrige = false;
	...
	public PartesMoModel(String appName, String profile) {
		...
		try {
			...
			addTableAlias(computeTableName("lote_carga_partes_mo"),
			...
			addColumn(computeTableName("partes_mo"), "parte_id",
					DataStore.DATATYPE_INT, true, true, PARTES_MO_PARTE_ID);
			...
			addColumn(computeTableName("partes_mo"), "lote_id",
					DataStore.DATATYPE_INT, false, true, PARTES_MO_LOTE_ID);
			addColumn(computeTableName("partes_mo"), "supervisor",
					DataStore.DATATYPE_INT, false, true, PARTES_MO_SUPERVISOR);
			...
			addColumn(computeTableName("partes_mo"), "proyecto_id",
					DataStore.DATATYPE_INT, false, true, PARTES_MO_PROYECTO_ID);
			addColumn(computeTableName("partes_mo"), "tarea_id",
					DataStore.DATATYPE_INT, false, true, PARTES_MO_TAREA_ID);
			...
			addColumn(computeTableName("lote_carga_partes_mo"), "estado",
					DataStore.DATATYPE_STRING, false, false,
					LOTE_CARGA_PARTES_MO_ESTADO);
			addColumn(computeTableName("lote_carga_partes_mo"), "fecha_alta",
					DataStore.DATATYPE_DATE, false, false,
					LOTE_CARGA_PARTES_MO_FECHA_ALTA);
			addColumn(computeTableName("lote_carga_partes_mo"), "fecha_cierre",
					DataStore.DATATYPE_DATE, false, false,
					LOTE_CARGA_PARTES_MO_FECHA_CIERRE);
			...
			addBucket(HORARIOS_BUCKET, DataStore.DATATYPE_STRING);
			...
			addJoin(computeTableAndFieldName("partes_mo.proyecto_id"),
					computeTableAndFieldName("proyectos.proyecto_id"), true);
			addJoin(computeTableAndFieldName("partes_mo.tarea_id"),
			...
			addRequiredRule(PARTES_MO_HORAS,
					"La cantidad de horas trabajadas es obligatoria para el parte");
			addRequiredRule(PARTES_MO_PROYECTO_ID,
					"El proyecto (OT) es obligatorio en el parte");
			addRequiredRule(PARTES_MO_TAREA_ID,
					"La tarea es obligatoria en el parte");
			addRequiredRule(PARTES_MO_PERSONAL_ID,
					"Se debe indicar un legajo para el parte");
			addRequiredRule(PARTES_MO_NRO_LEGAJO,
					"Se debe indicar un legajo para el parte");
			addRequiredRule(PARTES_MO_APEYNOM,
					"Se debe indicar un legajo para el parte");
			addRequiredRule(PARTES_MO_ESTADO,
					"Se debe indicar un estado para el parte");
	...
	/**
	 * Retrieve the value of the partes_mo.hora_desde column for the specified
	 * row.
	 * 
	 * @param row
	 *            which row in the table
	...
	/**
	 * Retrieve the value of the partes_mo.hora_hasta column for the specified
	 * row.
	 * 
	 * @param row
	 *            which row in the table
	...
	/**
	 * Retrieve the value of the partes_mo.supervisor column for the specified
	 * row.
	 * 
	 * @param row
	 *            which row in the table
	...
	/**
	 * Retrieve the value of the partes_mo.categoria column for the specified
	 * row.
	 * 
	 * @param row
	 *            which row in the table
	...
	/**
	 * Retrieve the value of the partes_mo.desc_categoria column for the current
	 * row.
	 * 
	 * @return String
	 * @throws DataStoreException
	...
	/**
	 * Retrieve the value of the partes_mo.desc_categoria column for the
	 * specified row.
	 * 
	 * @param row
	 *            which row in the table
	...
	/**
	 * Set the value of the partes_mo.desc_categoria column for the specified
	 * row.
	 * 
	 * @param row
	 *            which row in the table
	...
	/**
	 * Retrieve the value of the partes_mo.sector_id column for the specified
	 * row.
	 * 
	 * @param row
	 *            which row in the table
	...
	/**
	 * Retrieve the value of the partes_mo.proyecto_id column for the current
	 * row.
	 * 
	 * @return int
	 * @throws DataStoreException
	...
	/**
	 * Retrieve the value of the partes_mo.proyecto_id column for the specified
	 * row.
	 * 
	 * @param row
	 *            which row in the table
	...
	/**
	 * Retrieve the value of the partes_mo.personal_id column for the current
	 * row.
	 * 
	 * @return int
	 * @throws DataStoreException
	...
	/**
	 * Retrieve the value of the partes_mo.personal_id column for the specified
	 * row.
	 * 
	 * @param row
	 *            which row in the table
	 ...
	 * @throws DataStoreException
	 */
	public String getPartesMoNroLegajo() throws DataStoreException {
		return getString(PARTES_MO_NRO_LEGAJO);
	}

	/**
	 * Retrieve the value of the partes_mo.nro_legajo column for the specified
	 * row.
	 * 
	 * @param row
	 *            which row in the table
	 ...
	 * @throws DataStoreException
	 */
	public String getPartesMoNroLegajo(int row) throws DataStoreException {
		return getString(row, PARTES_MO_NRO_LEGAJO);
	}
	...
	public void setPartesMoNroLegajo(String newValue) throws DataStoreException {
		setString(PARTES_MO_NRO_LEGAJO, newValue);
	}
	...
	public void setPartesMoNroLegajo(int row, String newValue)
			throws DataStoreException {
		setString(row, PARTES_MO_NRO_LEGAJO, newValue);
	}
	...
	/**
	 * Retrieve the value of the sector_trabajo.nombre column for the current
	 * row.
	 * 
	 * @return String
	 * @throws DataStoreException
	...
	/**
	 * Retrieve the value of the sector_trabajo.nombre column for the specified
	 * row.
	 * 
	 * @param row
	 *            which row in the table
	...
	/**
	 * Retrieve the value of the supervisores.apeynom column for the specified
	 * row.
	 * 
	 * @param row
	 *            which row in the table
	...
	/**
	 * Retrieve the value of the lote_carga_partes_mo.estado column for the
	 * current row.
	 * 
	 * @return String
	 * @throws DataStoreException
	...
	/**
	 * Set the value of the lote_carga_partes_mo.estado column for the current
	 * row.
	 * 
	 * @param newValue
	 *            the new item value
	...
	/**
	 * Set the value of the lote_carga_partes_mo.estado column for the specified
	 * row.
	 * 
	 * @param row
	 *            which row in the table
	...
	/**
	 * Retrieve the value of the lote_carga_partes_mo.fecha_alta column for the
	 * current row.
	 * 
	 * @return java.sql.Date
	 * @throws DataStoreException
	 */
	public java.sql.Date getLoteCargaPartesMoFechaAlta()
			throws DataStoreException {
	 ...
	 * @throws DataStoreException
	 */
	public java.sql.Date getLoteCargaPartesMoFechaAlta(int row)
			throws DataStoreException {
		return getDate(row, LOTE_CARGA_PARTES_MO_FECHA_ALTA);
	}

	/**
	 * Set the value of the lote_carga_partes_mo.fecha_alta column for the
	 * current row.
	 * 
	 * @param newValue
	 *            the new item value
	 ...
	 * @throws DataStoreException
	 */
	public java.sql.Date getLoteCargaPartesMoFechaCierre()
			throws DataStoreException {
	 ...
	 * @throws DataStoreException
	 */
	public java.sql.Date getLoteCargaPartesMoFechaCierre(int row)
			throws DataStoreException {
		return getDate(row, LOTE_CARGA_PARTES_MO_FECHA_CIERRE);
	}

	/**
	 * Set the value of the lote_carga_partes_mo.fecha_cierre column for the
	 * current row.
	 * 
	 * @param newValue
	 *            the new item value
	...
	/**
	 * Retrieve the value of the horarios bucket for the current row.
	 * 
	 * @return String
	 * @throws DataStoreException
	 */
	public String getHorarios() throws DataStoreException {
		return getString(HORARIOS_BUCKET);
	}
	 ...
	 * @throws DataStoreException
	 */
	public String getHorarios(int row) throws DataStoreException {
		return getString(row, HORARIOS_BUCKET);
	}
	...
	public void setHorarios(String newValue) throws DataStoreException {
		setString(HORARIOS_BUCKET, newValue);
	}
	...
	public void setHorarios(int row, String newValue) throws DataStoreException {
		setString(row, HORARIOS_BUCKET, newValue);
	}
	...
	/**
	 * Habilita el control de los atributos del parte al llamar al metodo update
	 * del modelo. Si se setea en true, estos atributos son verificados
	 * automaticamente al llamar a update. Si es false, los metodos
	...
	public Connection getConexionTango() throws DataStoreException {
		...
		if (_connTango == null) {
			...
			_driverTango = _p.getProperty("driverTango",
			...
			try {
				...
				_connTango = DriverManager.getConnection(_urlTango, _userTango,
						_passWordTango);
			} catch (Exception e) {
				MessageLog.writeErrorMessage(e, null);
				throw new DataStoreException(
	...
	public int getDatosProyecto(int row) throws DataStoreException {
		...
		if ((proyecto != null) && (proyecto.trim().length() > 0)) {
			try {
				...
				MessageLog.writeErrorMessage(e, null);
				throw new DataStoreException("Error determinando proyecto: "
						+ e.getMessage());
			} finally {
				if (r != null) {
					try {
			...
			if (proyecto_id != -1) {
				...
				if (f == 0) {
					...
					setMensajeError(row,
							"Fecha de parte anterior a comienzo del proyecto.");
					proyecto_id = -1;
				} else if (f > 0) {
					setMensajeError(row,
							"Fecha de parte posterior a finalización del proyecto.");
					proyecto_id = -1;
				}
			}
		} else {
	...
	/**
	 * Add a task to a unit of work. If no task was specified set the first one
	...
	public int getDatosTarea(int row) throws DataStoreException {
		TareasProyectoModel dsTareasProyecto = new TareasProyectoModel(
				getAppName(), "proyectos");
		...
		try {
			// check if a task was specified and use it, if tarea lookup is not
			// disabled
	...
	/**
	 * Controla que la fecha del parte sea coherente con las fechas de inicio y
	...
	public boolean controlaLegajoTango(int row) throws DataStoreException {
		...
		try {
			SQL = "select L.ID_LEGAJO,L.NOMBRE,L.APELLIDO " + " from LEGAJO L"
					+ " where L.NRO_LEGAJO = '" + nro_legajo + "'";
			...
			if (r.first()) {
				...
				debug = "r.first";
				if (r.first()) {
					nro_legajo = String.valueOf(r.getInt(1)); // NRO_LEGAJO
					nombre = r.getString(2); // L.NOMBRE
					apellido = r.getString(3); // L.APELLIDO
				} else {
			...
			throw new DataStoreException("Error determinando legajo en tango: "
					+ e.getMessage() + " Debug: " + debug);
		} finally {
			if (r != null) {
				try {
					r.close();
		...
		if (supervisor > 0) {
			try {
				...
				SQL = "select personal_id, fecha_desde, fecha_hasta "
						+ "  from supervisores where nro_legajo = "
						+ getPartesMoSupervisor(row) + "";
				st = conexion.createStatement();
				r = st.executeQuery(SQL);
				...
				MessageLog.writeErrorMessage(e, null);
				throw new DataStoreException("Error determinando supervisor: "
						+ e.getMessage());
			} finally {
				if (r != null) {
					try {
			...
			if ((personal_id != -1)
					&& (verificaFechaPeriodo(getPartesMoFecha(row), fechaDesde,
							fechaHasta) != 0)) {
				if (getMensajeError(row) == null)
					setMensajeError(row,
							"La fecha del parte es anterior a la vigencia del cargo del supervisor");
				else
					setMensajeError(
							row,
							getMensajeError(row)
	...
	/**
	 * Controla que la fecha del parte dado pertenezca a por lo menos un periodo
	 ...
	 * @throws DataStoreException
	 */
	public boolean controlaFechaIngresoEgreso(java.sql.Date fechaparte,
			int legajoid) throws DataStoreException {
		Connection connTango;
		...
		try {
			...
			SQL = "SELECT I.ID_LEGAJO, I.FECHA_INGRESO, I.FECHA_EGRESO"
					+ " FROM INGRESO_EGRESO I " + " WHERE I.ID_LEGAJO = "
					+ Integer.toString(legajoid);
			debug = "createStatement 2";
			st = connTango.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,
					ResultSet.CONCUR_READ_ONLY);
			debug = "executeQuery 2";
			...
			// además de escribir en el log mando mensaje a la página
			throw new DataStoreException(
					"Error determinando fecha ingreso egreso en tango: "
							+ e.getMessage() + " Debug: " + debug);
		} finally {
			if (r != null) {
				try {
	...
	public int getLote(int row) throws DataStoreException {
		...
		if (fecha_parte == null) {
			setMensajeError(row,
					"La fecha del parte es obligatoria. Imposible calcular lote.");
			return -1;
		}
		...
		if (lote_id < 1) {
			...
			try {
				...
				// primero busco el circuito y la columna asociada a los partes
				SQL = "select lote_id" + "  from lote_carga_partes_mo "
		...
		if (cod_categoria == null || cod_categoria.trim().length() == 0) {
			try {
				SQL = " select CATEGORIA.COD_CATEGORIA, CATEGORIA.DESC_CATEGORIA"
						...
						+ " where LEGAJO.NRO_LEGAJO = '" + nro_legajo + "'";
	...
	public boolean parteDuplicado(int row) throws DataStoreException,
			SQLException {

		Date fechaRow = getPartesMoFecha(row);
		String nroLegajoRow = getPartesMoNroLegajo(row);
		...
		for (int i = 0; i < getRowCount(); i++) {
			// verifico lookup y actualiza los datos automáticos en caso de
			// insertar
			if (i != row
					&& (getRowStatus(i) == STATUS_NEW_MODIFIED || getRowStatus(i) == STATUS_MODIFIED)) {

				Date fechaI = getPartesMoFecha(i);
				String nroLegajoI = getPartesMoNroLegajo(i);
		...
		for (int i = 0; i < partesDB.getRowCount(); i++) {
			...
			if (parteId != partesDB.getPartesMoParteId(i)) {
				...
				String nroLegajoI = partesDB.getPartesMoNroLegajo(i);
	...
	public void validarPartes() throws DataStoreException, SQLException {
		...
		// realiza las tareas de lookup sobre los datos de tango y completa
		// información
		...
		for (int i = 0; i < getRowCount(); i++) {
			...
			if (getRowStatus(i) == STATUS_NEW_MODIFIED
					|| getRowStatus(i) == STATUS_MODIFIED || isCorrige()) {

				if (estado_inicial != null
						&& (getPartesMoEstado(i) == null || getPartesMoEstado(i)
								.trim().length() == 0))
					setPartesMoEstado(i, "0003.0002");
				else if (getPartesMoEstado(i) == null
						|| getPartesMoEstado(i).trim().length() == 0)
					setPartesMoEstado(i, "0003.0002");
	...
	public void liquidarPeriodo(int p_mes, int p_anio)
		...
		ResultSet r = null;
		String SQL = null;
		feriadosModel _dsFeriados = new feriadosModel("partesMO",
				"infraestructura");

		// valida los parámetros y acomoda el año en función de 2 o 4 dígitos
		if (p_mes < 1 || p_mes > 12)
			throw new DataStoreException(
					"Error en parámetro mes debe estar entre 1 y 12");

		if (p_anio < 1980 || p_anio > 2999)
			throw new DataStoreException(
					"Error en parámetro año. Debe ser de 4 dígitos");
		...
		try {
			...
			SQL = " delete from resumen_horas " + " where periodo between '"
					+ Integer.toString(p_anio) + "-" + Integer.toString(p_mes)
					+ "-01' " + "                and last_day('"
					+ Integer.toString(p_anio) + "-" + Integer.toString(p_mes)
					+ "-01')";
			...
			for (int i = 0; i < getRowCount(); i++) {
				// setea todas las variables de uso para determinar reglas de
				// liquidación
				String nro_legajo = getPartesMoNroLegajo(i);
				...
				tmpMinutos1 = tmpMinutosRemanentesDesde1
						+ tmpMinutosRemanentesHasta1;
				if (tmpMinutos1 > 59) {
				...
				if (dia2 != -1) {
					...
					tmpMinutos2 = tmpMinutosRemanentesDesde2
							+ tmpMinutosRemanentesHasta2;
					if (tmpMinutos2 > 59) {
				...
				if (hora_h >= 21 || hora_d < 6) {
					if (hora_h >= 21)
						if (hora_d > 21)
							...
							_nocturnas1 = _nocturnas1
									+ (double) (hora_h - 21)
									+ ((double) (tmpMinutosRemanentesHasta1 * 100 / 60) / 100.00);
					if (hora_d < 6)
						if (hora_h > 6)
							_nocturnas1 = _nocturnas1
									+ (double) (6 - hora_d)
				...
				if (_dsFeriados.esFeriado(new Date(cal.getTimeInMillis()))
					...
					_al_100_1 = _al_100_1 + horas1;
						...
						&& hora_h > 13)
					_al_100_1 = _al_100_1 + (double) (hora_h - 13)
							+ ((double) tmpMinutosRemanentesHasta1 * 100 / 60)
							/ 100.00;
				...
				setResumenHoras(resumen_id1, _horas1, _normales1, _al_50_1,
						_al_100_1, _nocturnas1);
				...
				if (resumen_id2 != -1) {
					...
					if (hora_h2 >= 21 || hora_d2 <= 6) {
						if (hora_h2 >= 21)
							if (hora_d2 > 21)
								_nocturnas2 = _nocturnas2
										+ (double) (hora_h2 - hora_d2)
										+ ((double) tmpMinutos2) / 100.00;
							else
								_nocturnas2 = _nocturnas2
										+ (double) (hora_h2 - 21)
										+ ((double) (tmpMinutosRemanentesHasta2 * 100 / 60) / 100.00);
						if (hora_d2 <= 6)
							if (hora_h2 > 6)
								_nocturnas2 = _nocturnas2
										+ (double) (6 - hora_d2)
										+ ((double) (tmpMinutosRemanentesDesde2 * 100 / 60) / 100.00);
							else
								_nocturnas2 = _nocturnas2
										+ (double) (hora_h2 - hora_d2)
										+ ((double) tmpMinutos2) / 100.00;
					...
					if (_normales2 < 0)
						_normales2 = 0;
					// actualiza la tabla resumen
					setResumenHoras(resumen_id2, _horas2, _normales2, _al_50_2,
							_al_100_2, _nocturnas2);
				}
	...
	private int getResumenHoras(int var, int dia, int mes, int anio,
			int quincena, int nro_legajo, String apeynom)
			throws DataStoreException {
		DBConnection conexion = null;
		Statement st = null;
		ResultSet r = null;
		...
		try {
			...
			MessageLog.writeErrorMessage(SQL, e, null);
			// además de escribir en el log mando mensaje a la página
			throw new DataStoreException("Error recuperando resumen de horas: "
					+ e.getMessage());
		} finally {
			if (r != null) {
				try {
	...
	private void setResumenHoras(int resumen_id, double horas, double normales,
			double al_50, double al_100, double nocturnas)
			throws DataStoreException {
		DBConnection conexion = null;
		Statement st = null;
		ResultSet r = null;
		...
		try {
			...
			// elimino los detalles de resumen para el período
			SQL = " update resumen_horas set " + "     horas = "
					+ Double.toString(horas) + " ," + "     normales = "
					+ Double.toString(normales) + " ," + "     al_50 = "
					+ Double.toString(al_50) + " ," + "     al_100 = "
					+ Double.toString(al_100) + " ," + "     nocturnas = "
					+ Double.toString(nocturnas) + " where resumen_id = "
					+ Integer.toString(resumen_id);
			st = conexion.createStatement();
			st.executeUpdate(SQL);
	 ...
	 * @throws DataStoreException
	 */
	public java.sql.Timestamp getPartesMoUltimaMod(int row)
			throws DataStoreException {
	...
	public void setCorrige(boolean _corrige) {
	...
	/**
	 * Completa el bucket del horario de las fichadas asociadas al cada parte
	 * cargado en el datastore.
	 * 
	 * @throws SQLException
	 * @throws DataStoreException
	 */
	public void completaHorasFichadas() throws SQLException, DataStoreException {
		DBConnection conexion = null;
		Statement st = null;
		ResultSet r = null;
		String SQL = null;
