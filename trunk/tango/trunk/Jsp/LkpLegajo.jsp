...
<salmon:form name="pageForm">
   ...
   <salmon:datasource name="dsQBE" type="QBE">
      <salmon:qbecriteria name="buscar" type="complex" 
         columns="LEGAJO.ID_LEGAJO, LEGAJO.NRO_LEGAJO, LEGAJO.CUIL, LEGAJO.NOMBRE, LEGAJO.APELLIDO" />
   </salmon:datasource>
   ...
   <salmon:box name="box2" width="100%">
      <salmon:listformdisplaybox name="listformdisplaybox1"
         ...
         datasource="dsLegajo" lookupreturnexp="LEGAJO.ID_LEGAJO"
         lookupdescreturnexp="LEGAJO.NRO_LEGAJO"
