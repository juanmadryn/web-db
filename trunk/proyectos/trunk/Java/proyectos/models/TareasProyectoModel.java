	...
	public TareasProyectoModel(String appName, String profile) {
		...
		try {
			...
			/*addLookupRule(
					...
					"actividades_proyecto",
					"'actividades_proyecto.actividad_id = '+ tareas_proyecto.actividad_proyecto_id + ' and actividades_proyecto.proyecto_id = '+  tareas_proyecto.proyecto_id ",
			...
			addLookupRule(
					...
					"clases_tareas.nombre", "clases_tareas.nombre", "Clase de tarea inexistente");
