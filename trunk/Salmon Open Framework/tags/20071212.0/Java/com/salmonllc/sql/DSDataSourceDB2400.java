...
/**
 * Driver for DB2 AS400
 * @author Denis Robert drobert@bfm.bm
 */
class DSDataSourceDB2400 extends DSDataSourceJDBC {

/**
 * DSSybaseDataSource constructor comment.
 */
public DSDataSourceDB2400() {
	super();
	_dateTimeFormat = new java.text.SimpleDateFormat("yyyy-MM-dd-HH.mm.ss");
}
