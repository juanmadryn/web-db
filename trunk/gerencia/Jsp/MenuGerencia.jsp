		...
		<table width="100%">
			<tr>
				<td><salmon:text name="text1"
					text="Bienvenido a la Aplicación Gerencia"
				...
				<FONT
					...
					COLOR="BLACK"><I> Aplicación para Administrar el módulo
				de Gerencia </I> </FONT></td>
			</tr>
			<tr>
				<td><br>
				<br>
				<salmon:text name="text2" text="Menú para Administrar el módulo de Gerencia"
					textlocalekey="textWelcome" font="PageHeadingFont" /> <BR>
				<FONT
					STYLE="FONT-FAMILY: Times New Roman, Times, Verdana, Helvetica, sans-serif; FONT-SIZE: 12pt;"
					COLOR="BLACK"><I> Menú principal de la Administración
				del módulo de Gerencia </I> </FONT><br>
				<br>
				</td>
			</tr>
		</table>
