	...
	public boolean esValido(Object obj, StringBuilder msg, DBConnection conn) {
		try {
			...
			if (ds.getObservaciones() == null
				...
				msg.append("Debe completar el cuadro de observaciones con la información suficiente para corregir la orden de compra");
				return false;
			}
			...
			if (!instancia.gotoFirst()) {
				msg.append("Usted no está autorizado para revisar la orden de compra en su estado actual");
				return false;
			}
