...
public class ArticulosExtendidosModel extends DataStore {
	...
	public ArticulosExtendidosModel(String appName, String profile) {
		...
		//add aliases
		addTableAlias(
			computeTableName("articulos_extendidos"),
	...
	/**
	 * Retrieve the value of the articulos_extendidos.articulo_id column for the current row.
	 * @return int
	...
	/**
	 * Retrieve the value of the articulos_extendidos.articulo_id column for the specified row.
	...
	/**
	 * Set the value of the articulos_extendidos.articulo_id column for the current row.
	...
	/**
	 * Set the value of the articulos_extendidos.articulo_id column for the specified row.
	 * @param row which row in the table
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the articulos_extendidos.clase_articulo_id column for the current row.
	 * @return int
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the articulos_extendidos.clase_articulo_id column for the specified row.
	 * @param row which row in the table
	 * @return int
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the articulos_extendidos.clase_articulo_id column for the current row.
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the articulos_extendidos.clase_articulo_id column for the specified row.
	 * @param row which row in the table
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the articulos_extendidos.nombre column for the current row.
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the articulos_extendidos.nombre column for the specified row.
	 * @param row which row in the table
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the articulos_extendidos.nombre column for the current row.
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the articulos_extendidos.nombre column for the specified row.
	 * @param row which row in the table
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the articulos_extendidos.descripcion column for the current row.
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the articulos_extendidos.descripcion column for the specified row.
	 * @param row which row in the table
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the articulos_extendidos.descripcion column for the current row.
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the articulos_extendidos.descripcion column for the specified row.
	 * @param row which row in the table
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the articulos_extendidos.observaciones column for the current row.
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the articulos_extendidos.observaciones column for the specified row.
	 * @param row which row in the table
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the articulos_extendidos.observaciones column for the current row.
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the articulos_extendidos.observaciones column for the specified row.
	 * @param row which row in the table
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the articulos_extendidos.descripcion_completa column for the current row.
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the articulos_extendidos.descripcion_completa column for the specified row.
	 * @param row which row in the table
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the articulos_extendidos.descripcion_completa column for the current row.
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the articulos_extendidos.descripcion_completa column for the specified row.
	 * @param row which row in the table
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	public void setArticulosExtendidosDescripcionCompleta(
		int row,
	...
	/**
	 * Retrieve the value of the articulos_extendidos.activo column for the current row.
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the articulos_extendidos.activo column for the specified row.
	 * @param row which row in the table
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the articulos_extendidos.activo column for the current row.
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the articulos_extendidos.activo column for the specified row.
	 * @param row which row in the table
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the articulos_extendidos.anulado column for the current row.
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the articulos_extendidos.anulado column for the specified row.
	 * @param row which row in the table
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the articulos_extendidos.anulado column for the current row.
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the articulos_extendidos.anulado column for the specified row.
	 * @param row which row in the table
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the articulos_extendidos.nombre_unidad column for the current row.
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the articulos_extendidos.nombre_unidad column for the specified row.
	 * @param row which row in the table
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the articulos_extendidos.nombre_unidad column for the current row.
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the articulos_extendidos.nombre_unidad column for the specified row.
	 * @param row which row in the table
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
