...
public class TipoMovimientoArticuloModel extends DataStore {
	...
	public TipoMovimientoArticuloModel(String appName, String profile) {
		...
		try {
			...
			addColumn(computeTableName("tipo_movimiento_articulo"),
					...
					true, true,
					TIPO_MOVIMIENTO_ARTICULO_TIPO_MOVIMIENTO_ARTICULO_ID);
			...
			addColumn(computeTableName("tipo_movimiento_articulo"),
					"descripcion", DataStore.DATATYPE_STRING, false, true,
					TIPO_MOVIMIENTO_ARTICULO_DESCRIPCION);
			addColumn(computeTableName("tipo_movimiento_articulo"),
					"observaciones", DataStore.DATATYPE_STRING, false, true,
					TIPO_MOVIMIENTO_ARTICULO_OBSERVACIONES);
			...
			// add validations
			addRequiredRule(TIPO_MOVIMIENTO_ARTICULO_NOMBRE,
					"El nombre del tipo de movimiento es obligatorio");
			addRequiredRule(TIPO_MOVIMIENTO_ARTICULO_POSITIVO,
	 ...
	 * tipo_movimiento_articulo.tipo_movimiento_articulo_id column for the
	 * current row.
	 * 
	 * @return int
	 * @throws DataStoreException
	 */
	public int getTipoMovimientoArticuloTipoMovimientoArticuloId()
			throws DataStoreException {
	 ...
	 * @throws DataStoreException
	 */
	public int getTipoMovimientoArticuloTipoMovimientoArticuloId(int row)
			throws DataStoreException {
		return getInt(row, TIPO_MOVIMIENTO_ARTICULO_TIPO_MOVIMIENTO_ARTICULO_ID);
	}

	/**
	 * Set the value of the tipo_movimiento_articulo.tipo_movimiento_articulo_id
	 ...
	 * @throws DataStoreException
	 */
	public void setTipoMovimientoArticuloTipoMovimientoArticuloId(int newValue)
			throws DataStoreException {
	 ...
	 * @throws DataStoreException
	 */
	public void setTipoMovimientoArticuloTipoMovimientoArticuloId(int row,
			int newValue) throws DataStoreException {
		setInt(row, TIPO_MOVIMIENTO_ARTICULO_TIPO_MOVIMIENTO_ARTICULO_ID,
				newValue);
	}
	...
	/**
	 * Retrieve the value of the tipo_movimiento_articulo.descripcion column for
	 * the current row.
	 * 
	 * @return String
	 * @throws DataStoreException
	 */
	public String getTipoMovimientoArticuloDescripcion()
			throws DataStoreException {
	 ...
	 * @throws DataStoreException
	 */
	public String getTipoMovimientoArticuloDescripcion(int row)
			throws DataStoreException {
		return getString(row, TIPO_MOVIMIENTO_ARTICULO_DESCRIPCION);
	}

	/**
	 * Set the value of the tipo_movimiento_articulo.descripcion column for the
	 * current row.
	 * 
	 * @param newValue
	 *            the new item value
	 * @throws DataStoreException
	 */
	public void setTipoMovimientoArticuloDescripcion(String newValue)
			throws DataStoreException {
	 ...
	 * @throws DataStoreException
	 */
	public void setTipoMovimientoArticuloDescripcion(int row, String newValue)
			throws DataStoreException {
		setString(row, TIPO_MOVIMIENTO_ARTICULO_DESCRIPCION, newValue);
	}

	/**
	 * Retrieve the value of the tipo_movimiento_articulo.observaciones column
	 * for the current row.
	 * 
	 * @return String
	 * @throws DataStoreException
	 */
	public String getTipoMovimientoArticuloObservaciones()
			throws DataStoreException {
	 ...
	 * @throws DataStoreException
	 */
	public String getTipoMovimientoArticuloObservaciones(int row)
			throws DataStoreException {
		return getString(row, TIPO_MOVIMIENTO_ARTICULO_OBSERVACIONES);
	}

	/**
	 * Set the value of the tipo_movimiento_articulo.observaciones column for
	 * the current row.
	 * 
	 * @param newValue
	 *            the new item value
	 * @throws DataStoreException
	 */
	public void setTipoMovimientoArticuloObservaciones(String newValue)
			throws DataStoreException {
	 ...
	 * @throws DataStoreException
	 */
	public void setTipoMovimientoArticuloObservaciones(int row, String newValue)
			throws DataStoreException {
	...
	// overwritten if the model is regenerated
	public static String getPositivo(int tipo_movimiento_articulo_id,
		...
		try {
			...
			ResultSet rs = st
					.executeQuery("SELECT positivo FROM tipo_movimiento_articulo WHERE tipo_movimiento_articulo_id = "
							+ tipo_movimiento_articulo_id);
			if (rs.first())
				return rs.getString("positivo");
			else
				return "";
		} finally {
			if (st != null)
	...
	public static String getReserva(int tipo_movimiento_articulo_id,
			DBConnection conn) throws DataStoreException, SQLException {
		Statement st = null;
		try {
			st = conn.createStatement();
			...
			ResultSet rs = st
					.executeQuery("SELECT reserva FROM tipo_movimiento_articulo WHERE tipo_movimiento_articulo_id = "
							+ tipo_movimiento_articulo_id);
			if (rs.first())
				return rs.getString("reserva");
			else
				return "";
		} finally {
			if (st != null)
