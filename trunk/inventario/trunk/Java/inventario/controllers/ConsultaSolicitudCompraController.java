...
public class ConsultaSolicitudCompraController extends BaseController implements
    ...
    public void pageRequested(PageEvent event) throws Exception {
        ...
        int solicitudes_pendientes = Utilities.getSolicitudesCompraPendientesAprobacion(currentUser);
        ...
        int solicitudes_observadas = Utilities.getSolicitudesCompraPendientesObservacion(currentUser);
