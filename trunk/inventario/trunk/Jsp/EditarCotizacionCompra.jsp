                  ...
                  <table border="0">
                     <tr>
                        ...
                        <salmon:input name="customBUT150" type="submit"
                           value="boton 6" accesskey="6" visible="False"></salmon:input></td>
                        <td><salmon:a
                     ...
                     <salmon:tr>
                        ...
                        <salmon:td colspan="3" align="CENTER">
                           ...
                           <salmon:lookup
                              ...
                              name="lkpCondicionesCompra1" size="2"
                              maxlength="50"
                        ...
                        -->
                           <salmon:lookup
                              browseimage="%ImageDirectory/Browse.gif"
                              lookupurl="%LkpCondicionesCompra"
                              name="lkpCondicionesCompra2" size="2"
                              maxlength="50"
                        ...
                        -->
                           <salmon:lookup
                              browseimage="%ImageDirectory/Browse.gif"
                              lookupurl="%LkpCondicionesCompra"
                              name="lkpCondicionesCompra3" size="2"
                              maxlength="50"
