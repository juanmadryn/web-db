...
<html>
<salmon:page
	controller="inventario.controllers.LkpTareasProyectoController" />
<salmon:body />
<salmon:form name="pageForm">
	...
	<salmon:datasource name="dsTareasProyecto" type="MODEL"
		...
		autoretrieve="Never">
		<salmon:selectioncriteria fieldname="tareas_proyecto.estado"
			operator="EQUAL" value="'0001.0001'" connector="OR" />
		<salmon:selectioncriteria fieldname="tareas_proyecto.estado"
			operator="EQUAL" value="'0001.0002'" connector="OR" />
		<salmon:selectioncriteria fieldname="tareas_proyecto.estado"
			operator="EQUAL" value="'0001.0003'" connector="OR" />
	</salmon:datasource>
	...
	<salmon:box name="box2" width="100%">
		<salmon:listformdisplaybox name="listformdisplaybox1"
			...
			lookupreturnexp="tareas_proyecto.tarea_id"
			lookupdescreturnexp="tareas_proyecto.nombre"
			...
			<salmon:datatable name="datatable1" width="100%" rowsperpage="5"
				...
				<salmon:datatablerows>
					<salmon:tr>
						...
						<salmon:td>
							<salmon:text name="tareasProyectoTXT7" text="nombre Goes Here"
								font="DefaultFont"
								datasource="dsTareasProyecto:tareas_proyecto.nombre" />
						</salmon:td>
						<salmon:td>
							<salmon:text name="tareasNombreTXT8" text="descripcion Goes Here"
								font="DefaultFont"
