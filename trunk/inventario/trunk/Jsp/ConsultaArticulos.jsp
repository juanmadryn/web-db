...
<salmon:page
	controller="inventario.controllers.ConsultaArticulosController" />
...
<salmon:form name="PageForm">
	...
	<salmon:datasource name="dsQBE" type="QBE">
		...
		<salmon:qbecriteria name="anulado" type="not_equeals"
			columns="articulos.anulado" />
	</salmon:datasource>
	<salmon:datasource name="dsArticulos" type="MODEL"
		dbprofile="inventario" model="inventario.models.ArticulosModel"
		autoretrieve="Never">
	</salmon:datasource>
	<!-- ********************************************************************************************* -->
			...
			<salmon:tr>
				<salmon:td valign="Top">
					<salmon:searchformdisplaybox name="searchformdisplaybox1"
						caption="Artículos" qbebuilder="dsQBE" searchbuttonvisible="false"
						...
						<table width="100%">
							...
							<tr>
								...
								<td colspan="1"><salmon:input name="valorAttr1" type="text" /></td>
							</tr>
							<tr>
								<td colspan="2" />
								<td><salmon:lookup browseimage="%ImageDirectory/Browse.gif"
								...
								<td colspan="1"><salmon:input name="valorAttr2" type="text" /></td>
							</tr>
							<tr>
								<td colspan="2" />
								<td><salmon:lookup browseimage="%ImageDirectory/Browse.gif"
								...
								<td colspan="1"><salmon:input name="valorAttr3" type="text" /></td>
							</tr>
						</table>
					...
					<salmon:tr>
						<salmon:td>
							<salmon:a href="none" name="lnkpartes1"
								...
								<salmon:text name="idTXT1" text="articulos.articulo_id"
									font="DefaultFont"
						...
						<salmon:td>
							<salmon:text name="nombreTE22" text="articulos.nombre"
								font="DefaultFont" datasource="dsArticulos:articulos.nombre" />
						</salmon:td>
						<salmon:td>
