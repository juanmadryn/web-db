...
<salmon:form name="PageForm">
   ...
   <salmon:datasource name="dsSolicitudCompra" type="MODEL"
      ...
      model="inventario.models.SolicitudCompraModel"
      autoretrieve="Never">
   </salmon:datasource>
         ...
         <salmon:tr>
            <salmon:td valign="Top">
               <salmon:detailformdisplaybox name="detailformdisplaybox1"
                  ...
                  datasource="dsSolicitudCompra"
                  buttondisplaylocation="IN_HEADER"
                  addbuttonvisible="false" cancelbuttonvisible="false"
                  savebuttonvisible="false" deletebuttonvisible="false">
                  <salmon:input name="customBUT100" type="submit"
                  ...
                  <table width="100%">
                     <tr>
                        <td><salmon:text
                           name="nombre_completo_solicitante1"
                        ...
                        <td><salmon:text
                           name="nombre_completo_comprador2" text=""
                     ...
                     <tr>
                        ...
                        <salmon:td name="proyectoTableTD">
                           <salmon:lookup
                              ...
                              lookupurl="%LkpProyectos" name="proyecto2"
                        ...
                        <salmon:td name="centroCostoTableTD">
                           <salmon:lookup
                              browseimage="%ImageDirectory/Browse.gif"
                              lookupurl="%LkpCentroCosto"
                              name="centro_costo2" size="15"
                              maxlength="15"
                     ...
                     <tr>
                        ...
                        <td><salmon:a href="" target="_blank"
                           ...
                           <salmon:img name="imprimirTXT2"
                              ...
                              srclocalekey="bannerImageSource" />
                        </salmon:a> <salmon:text name="espacio2" text=" "
                           font="TableHeadingFont" /> <salmon:a
               ...
               <table width="100%">
                  ...
                  <tr>
                     <td><salmon:input type="textarea"
                        ...
                        datasource="dsSolicitudCompra:observaciones"
         ...
         <salmon:datatable name="datatable2" width="100%"
            ...
            <salmon:datatableheader>
               ...
               <salmon:tr>
                  ...
                  <salmon:td colspan="2">
                     <salmon:text name="observaciones3"
                        text="Obsevaciones" font="TableHeadingFont" />
                  </salmon:td>
                  <salmon:td name="ccHeaderTd" nowrap="TRUE">
                     <salmon:text name="cc1" text="Cotización"
                        font="TableHeadingFont" />
                  </salmon:td>
            ...
            <salmon:datatablerows>
               <salmon:tr>
                  ...
                  <salmon:td>
                     <salmon:lookup
                        browseimage="%ImageDirectory/Browse.gif"
                        lookupurl="%LkpArticulos" name="articulo2"
                        size="10" maxlength="15"
                        datasource="dsDetalleSC:articulos.nombre"
                        descriptiondatasource="dsDetalleSC:articulos.descripcion"
                        popupheight="450" popupwidth="600"
                        usepopup="true" showdescription="true"></salmon:lookup>
                  </salmon:td>
                  <salmon:td>
                     <salmon:input type="text" name="descripcion4"
                  ...
                  <salmon:td>
                     <salmon:input type="text"
                        name="cantidad_solicitada2" size="8"
                        maxlength="15"
               ...
               <salmon:tr>
                  ...
                  <salmon:td colspan="2">
                     <salmon:input type="text" name="observaciones4"
