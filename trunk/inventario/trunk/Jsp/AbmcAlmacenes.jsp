...
<salmon:page controller="inventario.controllers.AbmcAlmacenesController" />
...
<salmon:form name="PageForm">
	...
	<salmon:datasource name="dsAlmacenes" type="MODEL" dbprofile="inventario"
		model="inventario.models.AlmacenesModel" autoretrieve="Never">
	</salmon:datasource>
	<!-- ********************************************************************************************* -->
			...
			<salmon:tr>
				<salmon:td valign="Top">
					<salmon:searchformdisplaybox name="searchformdisplaybox1"
						caption="Almacenes" qbebuilder="dsQBE">
						<table width="100%">
							<tr>
				...
				<salmon:td valign="Top">
					<salmon:detailformdisplaybox name="detailformdisplaybox1"
						caption="Editar Almacén" width="100%" datasource="dsAlmacenes"
						...
						<table width="100%">
							<tr>
								...
								<td><salmon:input type="text" name="nombreTE5" size="20"
									maxlength="90" datasource="dsAlmacenes:almacenes.nombre"></salmon:input>
								</td>
							</tr>
							<tr>
								...
								<td><salmon:input type="text" name="descripcionTE6"
									...
									datasource="dsAlmacenes:almacenes.descripcion"></salmon:input></td>
							</tr>
							<tr>
								...
								<td><salmon:input type="textarea" name="observacionesTE8"
									cols="80" rows="3" datasource="dsAlmacenes:almacenes.observaciones"></salmon:input></td>
							</tr>							
						</table>
	...
	<salmon:box name="box2" width="100%">
		<salmon:listformdisplaybox name="listformdisplaybox1"
			...
			datasource="dsAlmacenes" searchformdisplaybox="searchformdisplaybox1">
