...
<salmon:page controller="inventario.controllers.BaseController" />
...
<salmon:form name="PageForm">
	...
	<salmon:datasource name="dsFormasPago" type="MODEL" dbprofile="inventario"
		model="inventario.models.FormasPagoModel" autoretrieve="Never">
	</salmon:datasource>
	<!-- ********************************************************************************************* -->
			...
			<salmon:tr>
				<salmon:td valign="Top">
					<salmon:searchformdisplaybox name="searchformdisplaybox1"
						caption="Formas de Pago" qbebuilder="dsQBE">
						<table width="100%">
							<tr>
				...
				<salmon:td valign="Top">
					<salmon:detailformdisplaybox name="detailformdisplaybox1"
						caption="Editar Formas de Pago" width="100%" datasource="dsFormasPago"
						...
						<table width="100%">
							<tr>
								...
								<td><salmon:input type="text" name="nombreTE5" size="20"
									maxlength="50" datasource="dsFormasPago:formas_pago.nombre"></salmon:input>
								</td>
							</tr>
							<tr>
								...
								<td><salmon:input type="text" name="descripcionTE6"
									...
									datasource="dsFormasPago:formas_pago.descripcion"></salmon:input></td>
							</tr>
							<tr>
								...
								<td><salmon:input type="textarea" name="observacionesTE8"
									cols="40" rows="3" datasource="dsFormasPago:formas_pago.observaciones"></salmon:input></td>
							</tr>							
						</table>
	...
	<salmon:box name="box2" width="100%">
		<salmon:listformdisplaybox name="listformdisplaybox1"
			...
			datasource="dsFormasPago" searchformdisplaybox="searchformdisplaybox1">
