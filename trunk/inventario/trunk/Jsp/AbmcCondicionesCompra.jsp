...
<salmon:page controller="inventario.controllers.AbmcCondicionesCompraController" />
			...
			<salmon:tr>
				...
				<salmon:td valign="Top">
					<salmon:detailformdisplaybox name="detailformdisplaybox1"
						caption="Editar Condición de Compra" width="100%" datasource="dsCondicionesCompra"
						...
						<table width="100%">
							<tr>
								...
								<td><salmon:input type="text" name="nombreTE5" size="20"
									maxlength="50" datasource="dsCondicionesCompra:condiciones_compra.nombre"></salmon:input>
								</td>
							</tr>
							<tr>
								...
								<td><salmon:input type="text" name="descripcionTE6"
									...
									datasource="dsCondicionesCompra:condiciones_compra.descripcion"></salmon:input></td>
							</tr>
							<tr>
