		...
		<table width="100%">
			<tr>
				<td><salmon:text name="text1"
					text="Bienvenido al menu de Órdenes de Compra"
				...
				<FONT
					...
					COLOR="BLACK"><I> Aplicación para Administrar Órdenes de Compra
				</I> </FONT></td>
			</tr>
			<tr>
				<td><br>
				<br>
				<salmon:text name="text2" text="Menú para Administrar Órdenes de Compra"
					textlocalekey="textWelcome" font="PageHeadingFont" /> <BR>
				<FONT
					STYLE="FONT-FAMILY: Times New Roman, Times, Verdana, Helvetica, sans-serif; FONT-SIZE: 12pt;"
					COLOR="BLACK"><I> Menú principal de la Administración de
				Órdenes de Compra </I> </FONT><br>
				<br>
				</td>
			</tr>			
		</table>
