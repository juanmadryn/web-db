...
<salmon:page controller="inventario.controllers.AbmcCentroCostoController" />
			...
			<salmon:tr>
				...
				<salmon:td valign="Top">
					<salmon:detailformdisplaybox name="detailformdisplaybox1"
						caption="Editar Centro de Costo" width="100%" datasource="dsCentroCosto"
						...
						<table width="100%">
							<tr>
								...
								<td><salmon:input type="text" name="nombreTE5" size="20"
									maxlength="90" datasource="dsCentroCosto:centro_costo.nombre"></salmon:input>
								</td>
							</tr>
							<tr>
								...
								<td><salmon:input type="text" name="descripcionTE6"
									...
									datasource="dsCentroCosto:centro_costo.descripcion"></salmon:input></td>
							</tr>
							<tr>
								...
								<td><salmon:input type="textarea" name="observacionesTE8"
									cols="50" rows="3" datasource="dsCentroCosto:centro_costo.observaciones"></salmon:input></td>
							</tr>							
						</table>
					...
					<salmon:tr>
						<salmon:td>
							<salmon:text name="nombreTXT7"
								text="centro_costo.nombre Goes Here" font="DefaultFont"
								datasource="dsCentroCosto:centro_costo.nombre" />
						</salmon:td>
						<salmon:td>
							<salmon:text name="descripcionTXT8"
								text="centro_costo.descripcion Goes Here" font="DefaultFont"
						...
						<salmon:td>
							<salmon:text name="observacionesTXT9"
								...
								datasource="dsCentroCosto:centro_costo.observaciones" />
						</salmon:td>
					</salmon:tr>
				</salmon:datatablerows>
			</salmon:datatable>
