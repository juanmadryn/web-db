			...
			<salmon:datatable name="datatable2" width="100%"
				...
				<salmon:datatableheader>
					<salmon:tr>
						...
						<salmon:td>
							<salmon:text name="actividadCAP21" text="Descripción"
								font="TableHeadingFont" />
						</salmon:td>
						<salmon:td>
							<salmon:text name="idPadreCAP24" text="Pertence a"
								font="TableHeadingFont" />
						</salmon:td>
					</salmon:tr>
				</salmon:datatableheader>
				<salmon:datatablerows>
					<salmon:tr>
						...
						<salmon:td width="300">
							<salmon:lookup browseimage="%ImageDirectory/Browse.gif"
								lookupurl="%LkpActividades?p_es_hoja=true" name="actividadTE20"
						...
						<salmon:td>
							<salmon:text name="actividadCAP22" text="descripcion goes here"
								datasource="dsActividadesProyecto:actividades.descripcion"
								font="TableHeadingFont" />
						</salmon:td>
						<salmon:td>
							<salmon:text name="actividadPadreCAP21" text="id padre goes here"
								datasource="dsActividadesProyecto:actividad_padre.nombre"
								font="TableHeadingFont" />
						</salmon:td>
					</salmon:tr>
				</salmon:datatablerows>
			...
			<salmon:datatable name="datatable3" width="100%"
				...
				<salmon:datatablerows>
					<salmon:tr>
						...
						<salmon:td width="300">
							<salmon:lookup browseimage="%ImageDirectory/Browse.gif"
								lookupurl="%LkpClasesTarea" name="claseTareaTE34" size="4"
								...
								popupheight="500" popupwidth="500" usepopup="true"
								showdescription="true"></salmon:lookup>
						</salmon:td>
					</salmon:tr>
					<salmon:tr>
						...
						<salmon:td width="300">
							<salmon:lookup browseimage="%ImageDirectory/Browse.gif"
								lookupurl="" name="actividadTE21" size="15" maxlength="15"
								displayformat="##########0"
