...
<html>
<salmon:page controller="proyectos.controllers.LkpActividadesController" />
<salmon:body />
<salmon:form name="pageForm">
	...
	<salmon:box name="box2" width="100%">
		<salmon:listformdisplaybox name="listformdisplaybox1"
			...
			datasource="dsActividad" lookupreturnexp="actividades.actividad_id"
			...
			<salmon:datatable name="datatable1" width="100%" rowsperpage="5"
				...
				<salmon:datatableheader>
					<salmon:tr>
						...
						<salmon:td>
							<salmon:text name="nombrePadreCAP12" text="Pertenece a"
								font="TableHeadingFont" />
						</salmon:td>
					</salmon:tr>
				</salmon:datatableheader>
					...
					<salmon:tr>
						...
						<salmon:td>
							<salmon:text name="nombreTXT7" text="nombre Goes Here"
								font="DefaultFont" datasource="dsActividad:actividades.nombre" />
						</salmon:td>
						<salmon:td>
						...
						<salmon:td>
							<salmon:text name="padreTXT8" text="padre Goes Here"
								font="DefaultFont"
