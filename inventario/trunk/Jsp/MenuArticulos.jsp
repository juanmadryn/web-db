		...
		<table width="100%">
			<tr>
				<td><salmon:text name="text1"
					text="Bienvenido al menu de artículos" textlocalekey="textWelcome"
					font="SectionHeadingFont" /> <BR>
				<FONT
					STYLE="FONT-FAMILY: Times New Roman, Times, Verdana, Helvetica, sans-serif; FONT-SIZE: 12pt;"
					COLOR="BLACK"><I> Aplicación para Administrar Artículos
				</I> </FONT></td>
			</tr>
			<tr>
				<td><br>
				<br>
				<salmon:text name="text2" text="Menú para Administrar Artículos"
