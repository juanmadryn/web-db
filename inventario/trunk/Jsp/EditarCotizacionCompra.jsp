				...
				<salmon:td valign="Top">
					<salmon:detailformdisplaybox name="detailformdisplaybox1"
						...
						<table border="0" width="100%">
							<tr>
								<td colspan="7"><salmon:input name="customBUT100"
								...
								<td align="right"><salmon:a href="" target="_blank"
						...
						<salmon:table name="detalleCotizacion" border="1">
							<salmon:tr>
								...
								<salmon:td width="5%">
									<salmon:text name="solicitudCompra3" text="Nro. SM"
										font="TableHeadingFont" />
								</salmon:td>
								<salmon:td width="10%">
								...
								<salmon:td width="6%">
									<salmon:text name="precio_unitario_proveedor1"
										text="Precio 1" font="TableHeadingFont" />
								</salmon:td>
								<salmon:td width="6%">
									<salmon:text name="marca_proveedor1" text="Marca 1"
										font="TableHeadingFont" />
								</salmon:td>
								<salmon:td width="3%">
								...
								<salmon:td width="6%">
									<salmon:text name="precio_unitario_proveedor2"
										text="Precio 2" font="TableHeadingFont" />
								</salmon:td>
								<salmon:td width="6%">
									<salmon:text name="marca_proveedor2" text="Marca 2"
										font="TableHeadingFont" />
								</salmon:td>
								<salmon:td width="3%">
								...
								<salmon:td width="6%">
									<salmon:text name="precio_unitario_proveedor3"
										text="Precio 3" font="TableHeadingFont" />
								</salmon:td>
								<salmon:td width="6%">
									<salmon:text name="marca_proveedor3" text="Marca 3"
										font="TableHeadingFont" />
								</salmon:td>
								<salmon:td width="3%">
							...
							<salmon:tr>
								...
								<salmon:td colspan="3" align="left" width="15%">
							...
							<salmon:tr>
								...
								<salmon:td colspan="3" align="left">
							...
							<salmon:tr>
								...
								<salmon:td colspan="3">
									<salmon:lookup browseimage="%ImageDirectory/Browse.gif"
										...
										size="2" maxlength="10" displayformat="#########0"
							...
							<salmon:tr>
								<!--<salmon:listformdisplaybox name="listformdisplaybox2" supressheading="TRUE"
											...
											<salmon:tr>
												...
												<salmon:td width="10%">
													<salmon:text name="cantidad_solicitada2"
														text="cantidad_solicitada Goes Here" font="DefaultFont"
