...
<salmon:form name="pageForm">
   ...
   <salmon:datasource name="dsOrdenesCompra" type="MODEL"
      ...
      autoretrieve="Never">
      	<salmon:selection>
			<salmon:selectioncriteria fieldname="ordenes_compra.estado" operator="EQUALS" value="'0008.0001'" connector="or" />
			<salmon:selectioncriteria fieldname="ordenes_compra.estado" operator="EQUALS" value="'0008.0005'" />
		</salmon:selection>
        <salmon:selectioncriteria fieldname="ordenes_compra.estado" operator="EQUAL" value="'0008.0001'" connector="and"/>         
   </salmon:datasource>
