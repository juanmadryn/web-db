...
public class ArticulosModel extends BaseModel {
	...
	public ArticulosModel (String appName, String profile) { 
		...
		try {
			...
			//add validations
			addRequiredRule(ARTICULOS_ARTICULO_ID,"El Id del artículo es obligatorio");
			...
			addRequiredRule(ARTICULOS_ACTIVO,"Debe especificar si el artículo esta activo o no");
			addRequiredRule(ARTICULOS_ANULADO,"Debe especificar si el artículo esta anulado o no");
		}
