...
public class UnidadesMedidaModel extends DataStore {
	...
	/**
	 * Retrieve the value of the unidades_medida.unidad_medida_id column for the current row.
	 * @return int
	...
	/**
	 * Retrieve the value of the unidades_medida.unidad_medida_id column for the specified row.
	...
	/**
	 * Set the value of the unidades_medida.unidad_medida_id column for the current row.
	...
	/**
	 * Set the value of the unidades_medida.unidad_medida_id column for the specified row.
	 * @param row which row in the table
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the unidades_medida.nombre column for the specified row.
	 * @param row which row in the table
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the unidades_medida.descripcion column for the current row.
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the unidades_medida.descripcion column for the specified row.
	 * @param row which row in the table
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the unidades_medida.descripcion column for the current row.
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the unidades_medida.descripcion column for the specified row.
	 * @param row which row in the table
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the unidades_medida.observaciones column for the current row.
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Retrieve the value of the unidades_medida.observaciones column for the specified row.
	 * @param row which row in the table
	 * @return String
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the unidades_medida.observaciones column for the current row.
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
	...
	/**
	 * Set the value of the unidades_medida.observaciones column for the specified row.
	 * @param row which row in the table
	 * @param newValue the new item value
	 * @throws DataStoreException
	 */
